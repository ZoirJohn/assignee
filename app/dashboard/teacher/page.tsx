...
export default function TeacherDashboard() {
  ...
  return (
    <DashboardLayout userType="teacher" userName="Dr. Smith">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {submission.status === 'pending' && (
                          <Button size="sm" onClick={() => openSubmissionReview(submission)}>
                            Grade Now
                          </Button>
                        )}
                      </div>
            ...
            {selectedSubmission && (
              <Card className="border-2 border-blue-200 bg-blue-50/30">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button onClick={() => handleGradeSubmission(selectedSubmission.id)}>
                      Confirm Grade
                    </Button>
                ...
                <ScrollArea className="flex-1 mb-4">
                  <div className="space-y-4">
                    {chatMessages.map((msg) => (
                      ...
                      >
                        <div className={`flex items-start space-x-2 max-w-xs ${msg.sender === 'teacher' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                          <Avatar className="w-8 h-8">
                            <AvatarFallback>
                              {msg.sender === 'teacher' ? 'T' : 'S'}
                            </AvatarFallback>
                          </Avatar>
                          <div className={`p-3 rounded-lg ${msg.sender === 'teacher' ? 'bg-blue-600 text-white' : 'bg-gray-100'}`}>
