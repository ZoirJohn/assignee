        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
                <motion.div variants={staggerContainer} initial="initial" animate="animate">
                    <motion.div variants={fadeInUp} className="flex items-center justify-center space-x-2 mb-8">
                    ...
                    <motion.div variants={fadeInUp} className="mb-8">
                        <h1 className="text-8xl md:text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-4">
                            404
                        </h1>
                    ...
                    <motion.div variants={fadeInUp} className="mb-8">
                        ...
                        <p className="text-xl text-gray-600 mb-6 max-w-lg mx-auto">
                            Oops! The page you&apos;re looking for seems to have gone missing. Don&apos;t worry, even the best students
                            sometimes lose their assignments.
                        </p>
                    </motion.div>
